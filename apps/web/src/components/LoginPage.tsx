...
export function LoginPage({ onLogin }: LoginPageProps) {
  ...
  const handleGitHubLogin = async () => {
    ...
    try {
      ...
      const authUrl = 'https://collab-docs.collabdocs.workers.dev/auth/github';
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      const authUrl = 'https://collab-docs.collabdocs.workers.dev/auth/google';
      window.location.href = authUrl;
    } catch (err) {
    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 px-4 rounded-lg border border-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
        >
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
        >
