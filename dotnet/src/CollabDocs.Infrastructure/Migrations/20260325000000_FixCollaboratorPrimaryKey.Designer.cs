...
namespace CollabDocs.Infrastructure.Migrations
{
    ...
    [Migration("20260325000000_FixCollaboratorPrimaryKey")]
    partial class FixCollaboratorPrimaryKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollabDocs.Domain.Entities.DocumentCollaborator", b =>
                {
                    ...
                    b.HasIndex("DocumentId", "UserEmail")
                        .IsUnique();
            ...
            modelBuilder.Entity("CollabDocs.Domain.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
